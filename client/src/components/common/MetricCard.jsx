const toneStyles = {
  ...
  slate: {
    ...
    accent:
      "from-slate-500/35 to-slate-400/35 dark:from-slate-400/80 dark:to-slate-500/80",
  },
};
...
export const MetricCard = ({
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-md shadow-slate-200/70 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-slate-300/70 dark:border-slate-800 dark:bg-[#020617] dark:shadow-black/40 dark:hover:shadow-black/55 ${className}`}
    >
      <div
